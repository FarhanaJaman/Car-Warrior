...
import { Typography, Container, Card, CardContent, CardMedia, Paper, CardActions, CardHeader, IconButton } from '@mui/material';
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={4} sx={{ ml: 12, my: 5, mx: 'auto' }}>
                        <Card sx={{ maxWidth: 350, mx: 'auto' }}>
                            <CardHeader
                                avatar={
                                    <img src='https://i.ibb.co/X57DqxQ/logo.jpg' alt='card-header' style={{ width: '50px', borderRadius: '50%'}}/>
                                }
                                action={
